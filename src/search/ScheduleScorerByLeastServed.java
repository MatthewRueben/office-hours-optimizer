 ...
 */
public class ScheduleScorerByLeastServed implements ScheduleScorer
{
    ...
    public ScheduleScorerByLeastServed(boolean[][][] available, int minAdjacentSlotsToCount)//, int initialSaveCapacity)
    {
